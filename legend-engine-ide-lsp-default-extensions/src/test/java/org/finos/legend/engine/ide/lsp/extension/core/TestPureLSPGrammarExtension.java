...
public class TestPureLSPGrammarExtension extends AbstractLSPGrammarExtensionTest<PureLSPGrammarExtension>
{
    ...
    void functionTestsDiscovery()
    {
        ...
        Set<String> expectedCommands = Set.of(FunctionExecutionSupport.EXECUTE_COMMAND_ID, FunctionExecutionSupport.EDIT_IN_QUERYBUILDER_COMMAND_ID, PureLSPGrammarExtension.ACTIVATE_FUNCTION_ID);
